      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Delete Consultant Details</h5>
...
$row=mysql_fetch_array($query);
  ...
  ?>
  <form role="form" class="form-horizontal" method="POST" action="confirmdeleteconsultantdetails.php">
          <div class="modal-body">Sure Want To delete consultant inforamation of  <font color="#4e80d1"> <?php echo $row['name']; ?> ?</font></div>
