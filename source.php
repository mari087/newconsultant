  ...
  <div id="ModalLoginForm" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title"><b>Add Source</b></h5>
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addsourcedetails.php">
                    <input type="hidden" name="_token" value="">
                    <div class="form-group">
                        <label class="control-label">Source Name</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="sourcename" value="" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="hidden" class="form-control input-lg" name="date" value="<?php echo  date("Y-m-d"); ?>" required>
            ...
            <table class="table table-condensed" id="dataTable" width="100%" cellspacing="0">
              <thead bgcolor="#eeeeee">
                <tr>
                                            ...
                                            <th><font color="#4d4d4d">Source Name</font></th>
                                            <th><font color="#4d4d4d"> Address</font></th>
                                            <th><font color="#4d4d4d">Tax Id</font></th>
                                            
                                            <th><font color="#4d4d4d">Date</font></th>
              ...
              <tbody>
                <?php
                                                 include('dbcon.php');
                                                                $result= mysql_query("select *from sourcedetails" ) or die (mysql_error());
                ...
                <tr>
                         ...
                         <a href data-toggle="modal"  data-target="#deletemodal<?php echo $id; ?>"> <font color="#424242"><i class="fa fa-trash-o" aria-hidden="true" ></i></a>
                                           ...
                                           <?php include ('editsourcedetails.php');?> 
                                           <?php include ('deletesourcedetails.php');?> 
