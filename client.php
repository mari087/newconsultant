    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" method="POST" action="addclientdetails.php">
                    <input type="hidden" name="_token" value="">
                    <div class="form-group">
                        <label class="control-label">Client Name</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="clientname" value="" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Client Email</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="clientemail" value="" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Client Mobile Number</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="clientmobilenumber" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Client Location</label>
                        <div>
                            <input type="text" class="form-control input-lg" name="clientlocation" required>
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="control-label">Client address</label>
                        <div>
                            <textarea class="form-control custom-control" rows="3" name="clientaddress" style="resize:none" required></textarea> 
                        </div>
                    </div>
            ...
            <table class="table table-condensed" id="dataTable" width="100%" cellspacing="0">
              <thead bgcolor="#eeeeee">
                <tr>
                                            ...
                                            <th><font color="#4d4d4d">Client Name</font></th>
                                            <th><font color="#4d4d4d">Client Email</font></th>
                                            <th><font color="#4d4d4d">Client Mobile Number</font></th>
                                            
                                            <th><font color="#4d4d4d">Client Location</font></th>
              ...
              <tbody>
                ...
                <tr>
                         ...
                         <a href data-toggle="modal"  data-target="#newviewmodal<?php echo $id; ?>"> <font color="#424242"><i class="fa fa-eye" aria-hidden="true" ></i></a>
                                           ...
                                           <?php include ('editclientdetails.php');?> 
                                           <?php include ('deleteclientdetails.php');?> 
                                           <?php include ('viewclientdetails.php');?> 
